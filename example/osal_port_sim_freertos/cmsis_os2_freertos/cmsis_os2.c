...
#else
// TODO: kamin common
uint8_t global_irq_mask = 0;
// #define IS_IRQ_MASKED()           (__get_PRIMASK() != 0U)
#define IS_IRQ_MASKED() (global_irq_mask != 0U)
#endif
...
#else
// TODO: kamin common
uint8_t global_irq_mode = 0;
// #define IS_IRQ_MODE()             (__get_IPSR() != 0U)
#define IS_IRQ_MODE() (global_irq_mode)
#endif
...
*/
__WEAK void vApplicationGetIdleTaskMemory(StaticTask_t **ppxIdleTaskTCBBuffer, StackType_t **ppxIdleTaskStackBuffer,
                                          uint32_t *pulIdleTaskStackSize) {
